...
static yyconst flex_int16_t yy_base[20] =
    {   0,
        0,    0,   18,   19,   15,   19,    0,    7,    9,    7,
       19,   19,   11,    0,    0,    6,   19,   19,    9
    } ;

static yyconst flex_int16_t yy_def[20] =
    {   0,
       18,    1,   18,   18,   18,   18,   19,   19,   18,   18,
       18,   18,   18,   19,   19,   18,   18,    0,   18
    } ;

static yyconst flex_int16_t yy_nxt[30] =
    {   0,
        4,    5,    6,    7,    8,    9,   10,   11,    7,   12,
       14,   16,   13,   17,   16,   15,   13,   18,    3,   18,
